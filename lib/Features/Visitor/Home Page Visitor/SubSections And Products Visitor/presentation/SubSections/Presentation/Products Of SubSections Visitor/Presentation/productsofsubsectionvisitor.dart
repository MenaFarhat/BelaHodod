...
import 'package:belahodod/Features/Widgets/Static%20Widgets/simple_top_bar.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:phosphor_flutter/phosphor_flutter.dart';

import 'productitemofsubsectionvisitor.dart';

// ignore: must_be_immutable
class ProductsOfSubSectionVisitor extends StatefulWidget {
  ProductsOfSubSectionVisitor({
  ...
  @override
  State<ProductsOfSubSectionVisitor> createState() =>
      _ProductsOfSubSectionVisitorState();
}

class _ProductsOfSubSectionVisitorState
    extends State<ProductsOfSubSectionVisitor> {
  @override
  void initState() {
    context
