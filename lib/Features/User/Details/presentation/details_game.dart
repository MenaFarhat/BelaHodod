...
import 'package:belahodod/Features/User/Details/presentation/Bottom%20Part/bottom_part_game.dart';
import 'package:belahodod/Features/User/Details/presentation/Top%20Part/top_part_game.dart';
            ...
            return state.maybeWhen(
              ...
              success: (gameentity) {
                return ListView(
                  children: [
                    TopPartGame(
                      photos: gameentity.images == null
                          ? ["assets/images/logo.png"]
                          : gameentity.images!,
                      productId: widget.productID,
                      barcode: gameentity.barcode,
                      isFavorite: gameentity.isFavorite,
                      isLike: gameentity.isLiked,
                      isDislike: gameentity.isDisliked,
                      likeCount: gameentity.likeCount,
                    ),
                    SizedBox(
                    ...
                    BottomPartGame(
                      ...
                      section: gameentity.sectionName,
                      numofplayers: 5,
                      averageRating: gameentity.averageRating,
                      userRating: gameentity.userRating,
                      locations: locations,
                    ),
                  ],
                );
